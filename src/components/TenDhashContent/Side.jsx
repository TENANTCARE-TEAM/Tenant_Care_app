  ...
  return (
    ...
    <div className='flex items-center justify-center flex-col gap-2'>
     ...
     <ul className='flex flex-col gap-4 mt-4'>
        <Link to="/tenant/dashboard" className={`w-[140px] max-[768px]:w-full p-2 py-4 flex flex-col items-center gap-2 justify-center cursor-pointer  rounded-lg bg-[#F6F6F6]
        ...
        <Link to="/tenant/Properties" className={`w-[140px] max-[768px]:w-full p-2 py-4 flex flex-col items-center gap-2 justify-center cursor-pointer  bg-[#F6F6F6] rounded-lg
