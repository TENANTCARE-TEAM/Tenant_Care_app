            ...
            <ul className='grid grid-cols-4 gap-4'>
                ...
                <li className='flex flex-col gap-4'>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <li className='w-full text-center bg-[#00befe] p-3 px-4 rounded-lg font-medium text-sm text-white cursor-pointer transition-all hover:bg-sky-500'>Subscribe</li>
                    </div>
                </li>
            </ul>
        </footer>
