...
<div className='bg-white p-6 w-full flex flex-col shadow rounded'>
        ...
        {/* Recent items */}
        <div className='mt-4 flex flex-wrap gap-5 p-4 pb-5 mx-8 '>
            {/* item */}
            <Link to="/landlord/Dashboard/ViewProperty">
            <div className='flex gap-6 p-3 overflow-hidden w-[540px] h-[200px] bg-white shadow-2xl border-2 border-[#00befe] p-4 rounded-xl hover:scale-[0.98] cursor-pointer transition-all'>
