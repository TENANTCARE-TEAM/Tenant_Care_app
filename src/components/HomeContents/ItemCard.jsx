...
function ItemCard() {
  return (
    <div className='max-[768px]:px[6%] px-[9%] bg-white p-6 w-full flex flex-col shadow rounded'>
        <div className='flex items-center justify-between mx-16 max-[768px]:mx-6'>
            <h3 className='font-bold text-2xl max-[768px]:text-xl ml-[-9px]'>Recently Added</h3>
            <span className='text-[#00befe] max-[768px]:text-sm'>See all</span>
        </div>
        {/* Recent items */}
