...
function BuContent() {
  ...
  return (
    ...
    <h2 className="text-center font-medium text-2xl text-[#00befe]">Sign In Business</h2>
     <Formik
     ...
     <div className="flex justify-between items-center pt-4">
       ...
       <Link to="/busines/signUp" className="text-sm md:text-lg text-[#00befe] font-medium">
         Sign Up
       </Link>
     </div>
   </div>
