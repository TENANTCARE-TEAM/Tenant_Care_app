  ...
  return (
    <div className="mt-5 bg-white p-6 w-full flex flex-col shadow rounded">
      ...
      <div className="mt-4 flex flex-wrap gap-4 p-2 md:p-4 pb-5">
        ...
        <div className="flex flex-col gap-4  overflow-hidden md:w-[480px] h-auto w-full bg-white shadow-lg border-2 hover:border-[#00befe] p-4 rounded-xl hover:scale-[0.98] cursor-pointer transition-all">
          <div className="flex flex-col md:flex-row gap-4  ">
          <img
            src={house}
            alt=""
            className="w-full h-[200px] md:w-[250px] md:h-auto rounded-xl bg-auto bg-no-repeat bg-center"
          />
          <div className="flex flex-col gap-4 md:gap-7 w-full md:-full">
